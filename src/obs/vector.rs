    ...
    T: RealField,
{
        ...
        Self: Obs,
    {
        if self.is_valid() & other.is_valid() {
            (self - other).sum_of_squares() / tval!(N, usize)
    ...
    /// Set the observation value at the given index.
...
impl<T, const N: usize> Obs for ObsVec<T, N>
where
    T: RealField,
{
...
mod tests {
    ...
    #[test]
    fn test_ov_metric_internal_coordinates() {
        let array_1 =
    ...
    fn test_likelihood() {
        ...
        let covariance = MultivariateNormalDensity::new(
            DMatrix::from_diagonal_element(5, 5, 1.0),
            Domain::new_udomain(Dyn(5)),
            None,
        )
        .unwrap();
